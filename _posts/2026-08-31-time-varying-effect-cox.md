...
다음 글에서는 [시간가변 공변량의 시작–종료 자료 구조와 불멸시간 편향]({{ '/posts/survival-start-stop-immortal-time-bias/' | relative_url }})을 다룬다. 아직 관측되지 않은 미래의 노출을 기준시점에 붙이면 왜 결과 방향까지 달라질 수 있는지 살펴본다.
