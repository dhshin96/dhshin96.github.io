...
다음 글인 [생존분석 입문 ⑦: 랜드마크 분석으로 불멸시간 편향 피하기]({{ '/posts/survival-landmark-analysis/' | relative_url }})에서는 정해진 시점까지 사건 없이 남은 사람만 다시 비교하는 원리와, 랜드마크 이전 사건을 제외하면서 달라지는 해석 범위를 살펴본다.
