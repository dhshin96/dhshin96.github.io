...
다음 글인 [생존분석 입문 ⑧: 랜드마크 동적 예측과 예측 구간 Python 실습]({{ '/posts/survival-dynamic-landmark-prediction/' | relative_url }})에서는 여러 랜드마크 시점에서 생존예측을 갱신하고, 예측 시점과 예측 구간을 구분하는 법을 살펴본다.
