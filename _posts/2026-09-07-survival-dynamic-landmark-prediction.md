...
다음 글인 [생존분석 입문 ⑨: 시간별 Brier 점수와 동적 예측 보정 Python 실습]({{ '/posts/survival-dynamic-brier-calibration/' | relative_url }})에서는 랜드마크별 확률 오차와 보정 상태를 나누어 확인하고, 예측 시점마다 “잘 맞는다”는 말을 어떻게 평가하는지 배운다.
